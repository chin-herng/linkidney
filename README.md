...
What are the needs, or problems that current SMEs are facing?   
...
According to an article from MyCareersFuture, employers can receive an Senior Employment Credit (SEC) to offset up to 16% of the wages of employees who have disabilities, indicating a reduction on company expenses.  

Besides, employers can apply training grants when they enroll their employees in Workfare Training Schemes, which returns them with improved employees.   

Moreover, employers should not be worried about the performance of kidney patients as employers can apply for grants and employment services to train and integrate the patients under the Open Door Programme (ODP).  

Hence, employers, particularly employers from SMEs who do not possess much funds for hiring proficient employees and do not require high-level-educated employees can be benefited by hiring kidney patients who have limited education level. Simultaneously, kidney patients can grab the opportunity to contribute to the enterprises and earn some money. 
...
**Noted: Everything stated in this section is only applicable to the prototype, the usage of further implementation is stated in the Roadmap section.**
...
As the very first page when our user browses the web page, this page is identical for both employers and employees. After the users input a matching User ID and Password, they will be led to **2. Company / Employee Page**. The User ID and Password pair will be stored in our database. We can also facilitate our user to change their password if they have forgotten it.

Besides, users can also click into the **Individual** (user will be led to **3. Individual Page**) or **Business** (user will be led to **4. Business Page**) at the top of page to learn more about financial support or career path guidance for kidney patient and benefits for employers to hire kidney patients.

### 2. Company / Employee Page
...
As the very first page when our user browses the web page, this page is identical for both employers and employees. After the users input a matching User ID and Password, they will be led to **2. Job Position Page**. The User ID and Password pair will be stored in our database. We can also facilitate our user to change their password if they have forgotten it. 

Besides, users can also click into the **Individual** (user will be led to **5. Individual Page**) or **Business** (user will be led to **6. Business Page**) at the top of page to learn more about financial support or career path guidance for kidney patient and benefits for employers to hire kidney patients.
...
<ins>**Employer**</ins>  
The employers can choose from a list of existing job positions that they are hiring and click into it (user will be led to **3. Company / Employee Page**). Above the list of job positions, there are certain selection filters to focus the target to certain job title, potential employees’ living region, and desired occupation classification. If the employers are unable to find relevant job positions from the existing list, they can add a new job position in the list.

<ins>**Employee**</ins>  
The employees can choose their desired job positions from a list of existing job positions and click into it (user will be led to **3. Company / Employee Page**). Above the list of job positions, there are certain selection filters to focus the target to certain job title, company region, and desired occupation classification. 

### 3. Company / Employee Page
